...
<body>
    ...
    <div class="grid">
      ...
      <article class="card">
        <div class="icon" aria-hidden="true">
          <i data-lucide="link" style="width: 22px; height: 22px; stroke: #8a6a03;"></i>
        </div>
        <h3>Link Maestro</h3>
      ...
      <article class="card">
        <div class="icon" aria-hidden="true">
          <i data-lucide="shield-check" style="width: 22px; height: 22px; stroke: #8a6a03;"></i>
        </div>
      ...
      <article class="card">
        <div class="icon" aria-hidden="true">
          <i data-lucide="plug" style="width: 22px; height: 22px; stroke: #8a6a03;"></i>
        </div>
        <h3>IntegraSync</h3>
  ...
  <script>
    // Aguardar carregamento completo e inicializar Lucide icons
