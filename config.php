...
define('SITE_NAME', getenv('SITE_NAME') ?: 'Sistema de Licitações - CGLIC');
define('SITE_URL', getenv('SITE_URL') ?: 'https://cglic.net/');
...
function conectarDB() {
    ...
    if ($pdo === null) {
        try {
            ...
            error_log("ERRO CRÍTICO DB: " . $e->getMessage());
            error_log("DSN: $dsn");
            error_log("USER: " . DB_USER);

            // TEMPORÁRIO: Throw exception ao invés de die para debug
