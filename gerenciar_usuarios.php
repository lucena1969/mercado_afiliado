...
if ($_POST['acao'] ?? '' === 'atualizar_nivel') {
    ...
    try {
        ...
        if ($stmt->rowCount() == 0) {
            ...
            $pdo->exec("ALTER TABLE usuarios MODIFY tipo_usuario ENUM('admin','usuario','coordenador','diplan','dipli','diquali') DEFAULT 'usuario'");
        }
...
<head>
    ...
    <style>
        ...
        .nivel-5 { background: #e0e7ff; color: #5b21b6; }
        ...
        .nivel-info.diquali { border-color: #8b5cf6; }
            ...
            <form method="GET" class="filtros-grid">
                ...
                <div class="filtro-grupo">
                    ...
                    <select name="nivel">
                        ...
                        <option value="5" <?php echo $filtro_nivel == '5' ? 'selected' : ''; ?>>DIQUALI</option>
                    </select>
                </div>
        ...
        <div class="explicacao">
            ...
            <div class="niveis-info">
                ...
                <div class="nivel-info diquali">
                    <h4>🎯 Nível 5 - DIQUALI</h4>
                    <p>Foco em qualificação de demandas. Pode criar e gerenciar processos, visualizar PCA, relatórios avançados.</p>
                </div>
            </div>
        </div>
                ...
                <form method="POST" class="form-niveis">
                    ...
                    <div class="form-group">
                        ...
                        <select name="nivel_acesso" required>
                            ...
                            <option value="5" <?php echo ($usuario['nivel_acesso'] ?? 3) == 5 ? 'selected' : ''; ?>>
                                5 - DIQUALI (Qualificação)
                            </option>
                        </select>
                    </div>
