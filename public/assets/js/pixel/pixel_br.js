...
(function(window, document){
  ...
  var TEST_COLLECTOR = window.location.origin + "/mercado_afiliado/api/pixel/test.php";
  ...
  PixelBR.init = function(opts){
    ...
    config.testMode = opts.testMode || config.testMode;
    
    // Se estiver em modo de teste, usar endpoint de teste
    if(config.testMode) {
      config.collector = TEST_COLLECTOR;
      if(config.debug) console.log('[PixelBR] Test Mode Enabled - Using test endpoint');
    }
