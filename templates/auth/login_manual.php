...
<head>
    ...
    <title>Login Manual OAuth - <?= APP_NAME ?></title>
    ...
    <div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 2rem;">
        <div style="width: 100%; max-width: 400px;">
            ...
            <div style="text-align: center; margin-bottom: 2rem;">
                ...
                <p style="color: #10b981; margin-top: 0.5rem; font-weight: 600;">🚀 OAuth Manual (sem vendor/)</p>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        <a href="<?= BASE_URL ?>/auth/google?manual=1" 
                    ...
                    <div style="background: #f3f4f6; padding: 1rem; border-radius: 8px; font-size: 0.875rem; margin-bottom: 1rem;">
                        <strong>Status Google OAuth:</strong><br>
                        <?= (GOOGLE_CLIENT_ID !== 'teste-google-id') ? '✅ Configurado e pronto para usar' : '⚠️ Configure suas credenciais reais em config/app.php' ?>
                        <br><small style="color: #6b7280;">Google Cloud Console → APIs & Serviços → Credenciais</small>
                    </div>
            ...
            <div style="text-align: center; margin-top: 1.5rem; color: var(--color-gray);">
                ...
                <a href="<?= BASE_URL ?>/login" style="color: #6b7280; font-size: 0.875rem;">← Login normal</a>
            </div>
        </div>
    </div>
