    ...
    <div style="display: flex; min-height: 100vh; background: #f9fafb;">
        ...
        <aside class="sidebar" style="width: 280px; background: white; border-right: 1px solid #e5e7eb; position: sticky; top: 0; height: 100vh; overflow-y: auto;">
            <ul class="sidebar-menu">
                <li><a href="<?= BASE_URL ?>/dashboard"><i data-lucide="layout-dashboard"></i> Dashboard</a></li>
                <li><a href="<?= BASE_URL ?>/unified-panel"><i data-lucide="trending-up"></i> Painel Unificado</a></li>
                <li><a href="<?= BASE_URL ?>/integrations" class="active"><i data-lucide="plug"></i> IntegraSync</a></li>
        ...
        <main style="flex: 1; padding: 2rem; overflow-x: hidden;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                <div style="display: flex; align-items: center; gap: 12px;">
                    <i data-lucide="plug" style="width: 32px; height: 32px; color: var(--color-primary);"></i>
                    <div>
                ...
                <div style="display: flex; gap: 1rem;">
                    ...
                    <a href="<?= BASE_URL ?>/integrations/test" class="btn btn-secondary">
                        <i data-lucide="flask-conical"></i> Teste & Logs
                    </a>
                </div>
            </div>
                ...
                <div class="card-body">
                    <?php if (empty($integrations)): ?>
                        ...
                        <div style="text-align: center; padding: 3rem 1rem;">
                            <i data-lucide="plug" style="width: 64px; height: 64px; margin: 0 auto 1rem; color: var(--color-gray);"></i>
                            ...
                            <a href="<?= BASE_URL ?>/integrations/add" class="btn btn-primary">
                                <i data-lucide="rocket"></i> Configurar primeira integração
                            </a>
                        </div>
                    <?php else: ?>
                        <!-- Lista de integrações -->
