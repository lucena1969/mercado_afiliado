    ...
    <div style="display: flex; min-height: 100vh; background: #f9fafb;">
        ...
        <aside class="sidebar" style="width: 280px; background: white; border-right: 1px solid #e5e7eb; position: sticky; top: 0; height: 100vh; overflow-y: auto;">
            <ul class="sidebar-menu">
                ...
                <li><a href="<?= BASE_URL ?>/link-maestro" class="active"><i data-lucide="link"></i> Link Maestro</a></li>
        ...
        <main style="flex: 1; padding: 2rem; overflow-x: hidden;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                <div>
                    <h1 style="margin: 0; color: var(--color-dark); display: flex; align-items: center; gap: 0.5rem;"><i data-lucide="link"></i> Link Maestro</h1>
                ...
                <button id="createLinkBtn" class="btn btn-primary" style="display: flex; align-items: center; gap: 0.5rem;">
                    <i data-lucide="plus"></i> Criar Link
                </button>
            </div>
