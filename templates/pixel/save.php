...
try {
    ...
    if ($action === 'save_config') {
        ...
        $pixelConfig->status = 'active'; // Ativar imediatamente
        ...
        if ($config_id) {
            ...
            if ($pixelConfig->create()) {
                ...
                $response = [
                    'success' => true,
                    'message' => '🎉 Pixel criado com sucesso! O código já está disponível na aba "Código". Configure as integrações na aba "Bridges".',
